...
export default async function RootLayout({ children, params }: LayoutProps) {
  ...
  const appProviderProps = { contentfulPreviewProviderProps, translationProviderProps}
  const bodyClassNames = clsx('font-sans min-h-screen bg-white dark:bg-zinc-900', raleway.variable);
